                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {item.company === "SelaNet.ai" && (
                      <div className="flex items-center gap-2">
                        <a href="https://x.com/selanetai" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full border border-border text-muted-foreground hover:text-accent hover:border-accent transition-colors" aria-label="X (Twitter)">
                          <FiTwitter size={14} />
                        </a>
                        <a href="https://discord.com/invite/NGrHGDCGd" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full border border-border text-muted-foreground hover:text-accent hover:border-accent transition-colors" aria-label="Discord">
